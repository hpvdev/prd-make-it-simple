...
- **DL-08 (P) — Chặn đặt trùng giờ một thợ**: không cho 2 hẹn đè giờ cùng một thợ. *Xong khi: hệ thống từ chối và báo khung đã bận.*
...
### C5 — Nhắc lịch (mã: NL)
- **NL-01 (C) — Nhắc khách trước giờ hẹn** (vd trước 24h và 2h) qua Zalo/SMS/email. *Xong khi: tới mốc, đúng múi giờ, tin nhắc được gửi.*
...
- **SYS-11 — Quyền riêng tư & điều khoản**: trang chính sách, đồng ý nhận tin nhắc.
